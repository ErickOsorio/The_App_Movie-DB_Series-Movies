...
public class upcomingModel implements upcomingInterface.Model {
    ...
    public upcomingModel(Context context) {
    ...
    private class asyncHttpRequestManager extends AsyncTask<Void,String,Integer> {
        ...
        public asyncHttpRequestManager(Context context, String url, String apiKey, String language, int page, upcomingInterface.Presenter mPresenter) {
            this.context = context;
            this.url = url;
            this.apiKey = apiKey;
